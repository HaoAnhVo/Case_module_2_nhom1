...
<!-- register Start -->
<div class="container-xxl py-5 wow fadeInUp login" data-wow-delay="0.1s">
    <div class="container">
        <div class="row g-5">
            <div class="col-md-12">
                <div class="tabs">
                    <div class="tab-content" id="myTabContent">
                        ...
                        >
                            <h1 class="text-white text-center m-5">Chào Mừng Bạn Quay Trở Lại!</h1>
                            <form action="LoginServlet" method="post" class="text-white">
                                <div class="row g-3">
                                    <div class="col-md-6 offset-3">
                                        <div class="form-floating form-input">
                                            <input
                                                    type="text"
                                                    name="username"
                                                    class="form-control form-login bg-transparent"
                                            ...
                                            ><i class="fa-solid fa-users me-3"></i>Tên tài khoản</label
                                            >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 offset-3">
                                        <div class="form-floating">
                                            ...
                                            ><i class="fa-solid fa-lock me-3"></i>Mật khẩu</label
                                            >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <button
                                                class="btn btn-outline-light w-25 py-3 mt-4 d-block m-auto login-btn"
                                                type="submit"
                                        >
                                            Đăng nhập
                                        </button>
                                        ...
                                        <p class="text-white text-center mt-4">
                                            ...
                                            <a href="register.jsp" style="color: var(--secondary)"
                                            >Đăng Ký</a
                                            >
                                        </p>
                                    </div>
