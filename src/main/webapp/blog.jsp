...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            <c:forEach var="category" items="${groupedPostsByCategory}">
                <h2 class="mb-4 mt-5 text-center" style="font-size: 2.2rem">${category.key}</h2>
                <div class="row">
                <c:forEach var="post" items="${category.value}" varStatus="status">
                        ...
                        <div class="package-item">
                            <a href="PostServlet?action=view&view=detail-blog&postId=${post.postId}">
                                ...
                                <div class="d-flex border-bottom p-2">
                                    <h5 class="flex-fill py-2 mt-1">${post.title}</h5>
                                </div>
                                <div class="p-3">
                                    <p class="desc">${post.content}</p>
                                    <div class="d-flex justify-content-center mb-2">
                                        <button class="btn btn-sm btn-primary px-3" style="border-radius: 30px">Đọc thêm</button>
                                    </div>
                                </div>
                            </a>
                        </div>
