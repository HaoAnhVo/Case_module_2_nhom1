...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>MeTrip - Ha Noi Blog Page</title>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="row g-4 justify-content-center">
                    <h2 class="mb-4 mt-4 text-center" style="font-size: 2.2rem">Hà Nội</h2>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="package-item">
                            <a href="#!">
                                ...
                                <div class="d-flex border-bottom p-2">
                                    <h5 class="flex-fill py-2 mt-1">Hà Nội title 2</h5>
                                </div>
                                <div class="p-3">
                                    <p class="desc">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="package-item">
                            <a href="#!">
                                ...
                                <div class="d-flex border-bottom p-2">
                                    <h5 class="flex-fill py-2 mt-1">Hà Nội title 3</h5>
                                </div>
                                <div class="p-3">
                                    <p class="desc">
