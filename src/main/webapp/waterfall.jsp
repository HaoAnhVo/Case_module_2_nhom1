                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="./waterfall.jsp" class="dropdown-item active">Thác nước</a>
                        ...
                        <div class="package-item">
                            <a href="detail-blog.jsp">
                                ...
                                <div class="d-flex border-bottom p-2">
                                    <h5 class="flex-fill py-2 mt-1">Thác nước title 1</h5>
                                </div>
                                <div class="p-3">
                                    <p class="desc">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="package-item">
                            <a href="#!">
                                ...
                                <div class="d-flex border-bottom p-2">
                                    <h5 class="flex-fill py-2 mt-1">Thác nước title 2</h5>
                                </div>
                                <div class="p-3">
                                    <p class="desc">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="package-item">
                            <a href="#!">
                                ...
                                <div class="d-flex border-bottom p-2">
                                    <h5 class="flex-fill py-2 mt-1">Thác nước title 3</h5>
                                </div>
                                <div class="p-3">
                                    <p class="desc">
