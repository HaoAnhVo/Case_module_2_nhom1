...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>MeTrip - Destination Page</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-2 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="destination.jsp" class="nav-item nav-link active">Địa điểm</a>
                ...
                <div class="container py-5">
                    <div class="row justify-content-center py-5">
                        <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                            <h1 class="display-3 text-white animated slideInDown">Vi Vu Việt Nam</h1>
                            <p class="fs-4 mb-4 animated slideInDown" style="color: var(--primary); font-size: 1.6rem">
                                Chọn một địa điểm và bắt đầu khám phá
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xxl py-5 destination">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title bg-white text-center text-primary px-3 mb-4">Địa điểm du lịch</h6>
                </div>
                <div class="row g-3">
                    <h1 class="text-center mb-2">Miền Bắc</h1>
                    <div class="col-lg-12 col-md-12">
                        <div class="row g-3">
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.1s">
                                <a class="position-relative d-block overflow-hidden" href="hanoi_blog.jsp">
                                    <img class="img-fluid" src="./img/destinations/Bac/hanoi.png" alt="" />
                                    <div
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.3s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Bac/caobang.png" alt="" />
                                    <div
                                        class="bg-white text-primary fw-bold position-absolute bottom-0 end-0 m-3 py-1 px-2"
                                    >
                                        Cao Bằng
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.5s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Bac/halong.png" alt="" />
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.1s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Bac/langson.png" alt="" />
                                    <div
                                        class="bg-white text-primary fw-bold position-absolute bottom-0 end-0 m-3 py-1 px-2"
                                    >
                                        Lạng Sơn
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.3s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img
                                        class="img-fluid"
                                        src="./img/destinations/Bac/ninhbinh.png"
                                        alt=""
                                        style="height: 232px"
                                    />
                                    <div
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.5s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Bac/sapa.png" alt="" />
                ...
                <div class="mt-5 row g-3">
                    <h1 class="text-center mb-2">Miền Trung</h1>
                    <div class="col-lg-12 col-md-12">
                        <div class="row g-3">
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.1s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Trung/hue.png" alt="" />
                                    <div
                                        class="bg-white text-primary fw-bold position-absolute bottom-0 end-0 m-3 py-1 px-2"
                                    >
                                        Huế
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.3s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img
                                        class="img-fluid"
                                        src="./img/destinations/Trung/danang.png"
                                        alt=""
                                        style="height: 232px"
                                    />
                                    <div
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.5s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Trung/binhdinh.png" alt="" />
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.1s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img
                                        class="img-fluid"
                                        src="./img/destinations/Trung/hoian.png"
                                        alt=""
                                        style="height: 232px"
                                    />
                                    <div
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.3s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img
                                        class="img-fluid"
                                        src="./img/destinations/Trung/quangbinh.png"
                                        alt=""
                                        style="height: 232px"
                                    />
                                    <div
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.5s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Trung/quangngai.png" alt="" />
                ...
                <div class="row g-3 mt-5">
                    <h1 class="text-center mb-2">Miền Nam</h1>
                    <div class="col-lg-12 col-md-12">
                        <div class="row g-3">
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.1s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Nam/saigon.png" alt="" />
                                    <div
                                        class="bg-white text-primary fw-bold position-absolute bottom-0 end-0 m-3 py-1 px-2"
                                    >
                                        Sài Gòn
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.3s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Nam/dalat.png" alt="" />
                                    <div
                                        class="bg-white text-primary fw-bold position-absolute bottom-0 end-0 m-3 py-1 px-2"
                                    >
                                        Đà Lạt
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.5s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Nam/cuulong.png" alt="" />
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.1s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Nam/phuquoc.png" alt="" />
                                    <div
                                        class="bg-white text-primary fw-bold position-absolute bottom-0 end-0 m-3 py-1 px-2"
                                    >
                                        Phú Quốc
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.3s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img class="img-fluid" src="./img/destinations/Nam/angiang.png" alt="" />
                                    <div
                                        class="bg-white text-primary fw-bold position-absolute bottom-0 end-0 m-3 py-1 px-2"
                                    >
                                        An Giang
                            ...
                            <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.5s">
                                <a class="position-relative d-block overflow-hidden" href="">
                                    <img
                                        class="img-fluid"
                                        src="./img/destinations/Nam/vungtau.png"
                                        alt=""
                                        style="height: 232px"
                                    />
        ...
        <div class="container-fluid bg-dark text-light footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h4 class="text-white mb-3">Tim mới</h4>
